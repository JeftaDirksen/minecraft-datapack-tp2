...
tellraw @s ["",{text:"Teleported home (",color:"green"},{text:"Go back",color:"yellow",bold:true,click_event:{action:"run_command",command:"/trigger tp-back"}},{text:")",color:"green"}]
